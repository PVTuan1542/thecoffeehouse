...
public class tab1 extends Fragment {
    ...
    public void recycle_list(){
        ...
        orderItems.add(new orderItem("TRÀ SỮA MẮC CA TRÂN CHÂU TRẮNG","45.000đ", R.drawable.trasuamatcatranchau));
        orderItems.add(new orderItem("Socola Lúa Mạch Nóng","69.000đ", R.drawable.product_9));
        orderItems.add(new orderItem("TRÀ ĐÀO CAM SẢ","45.000đ", R.drawable.tradaocamsa));
        orderItems.add(new orderItem("TRÀ ĐEN MACCHIATO","43.000đ", R.drawable.tradenmachiato));
        orderItems.add(new orderItem("Bạc sỉu","32.000đ", R.drawable.bacsiu));
        orderItems.add(new orderItem("Socola Lúa Mạch Nóng","32.000đ", R.drawable.product_10));
        orderItems.add(new orderItem("Socola Lúa Mạch Nóng","34.000đ", R.drawable.product_11));
        orderItems.add(new orderItem("Socola Lúa Mạch Nóng","40.000đ", R.drawable.coffee_2));
        orderItems.add(new orderItem("Socola Lúa Mạch Nóng","50.000đ", R.drawable.coffee_1));
